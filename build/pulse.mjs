...
await c.send('Runtime.evaluate',{expression:"document.querySelector('#pulse').scrollIntoView({block:'center'})"});
await sleep(900);
const r=await c.send('Page.captureScreenshot',{format:'png'});
writeFileSync(`${DIR}/pulse-band.png`,Buffer.from(r.result.data,'base64'));
console.log('shot');
process.exit(0);
