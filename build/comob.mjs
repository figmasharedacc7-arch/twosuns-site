...
for(const [w,h,mob,name] of [[1440,900,false,'co-1440.png'],[1024,860,false,'co-1024.png'],[390,860,true,'co-390.png']]){
  ...
  console.log(name.padEnd(12),'doc',await ev('document.documentElement.scrollWidth'),'vw',await ev('innerWidth'));
}
process.exit(0);
